      ...
      <div className="card shadow-lg border-0" style={{maxWidth: 400, width: '100%'}}>
        <div className="card-body p-5">
          <div className="d-flex flex-column align-items-center mb-4">
            <div className="rounded-circle bg-success bg-opacity-10 d-flex align-items-center justify-content-center mb-3" style={{width: 56, height: 56}}>
              <svg width="32" height="32" fill="currentColor" className="text-success" viewBox="0 0 16 16"><path d="M8 0a8 8 0 1 0 0 16A8 8 0 0 0 8 0zm0 14.5A6.5 6.5 0 1 1 8 1.5a6.5 6.5 0 0 1 0 13z"/></svg>
            </div>
            <h2 className="fw-bold mb-1 text-success">Créer un compte</h2>
            <p className="text-muted mb-0">Inscrivez-vous pour continuer</p>
          </div>
          ...
          <div className="text-center mb-2">
            <a href="/login" className="text-success">Déjà un compte ? Se connecter</a>
          </div>
